        ...
        <script>
            $(document).ready(function() {
                $(".del").click(function() {
                    ...
                    if (status == true)
                    {
                        window.location.href = "admin_code/delfbcode.jsp?rid=" + id;
                    }
                });
    ...
    <body>
        <div class="container-fluid outer">
            ...
            <div class="row main"  style="opacity: 1;margin-top:-20px;background-image: url(../images/c5.png);background-repeat: no-repeat;background-size: cover;">
                <div class="cols-sm-12 h1 text-center" style="font-family: Bodoni MT Black;color: white;text-shadow: 5px 5px 5px black;">Feedback Management</div>
                ...
                <div class="col-sm-12"><hr/>
                    <br/><table style="box-shadow: 4px 4px 5px black;" class="table table-bordered table-hover">
                        ...
                        <%
                            int n = 1;
                            String q = "select * from feedback order by fid desc";
                        ...
                        <tr class="warning" style="color:#330033;font-weight: bold;">
                            ...
                            if(rs2!=null)
                           {
                            ...
                            <td><%=rs.getString("cdate")%></td>
                             <td><span style="display: none;" class="mid"><%=rs.getString("userid")%></span><span  title="Delete" style="color: red;font-weight: bold;cursor: pointer;" class="glyphicon glyphicon-trash del"></span></td>
                        </tr>
                        <%
                                n++;
                            }
