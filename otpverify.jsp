                ...
                <div class="container sec">
                    <br/><center>
                        ...
                        <div id="outer2"  class="col-sm-9" style="box-shadow:5px 5px 25px black;margin-left: 12%;border-radius:5px;">
                            ...
                            <form action="generalcode/verifycode.jsp" method="post">
                                <br/><br/><input type="text" name="otp" class="form-control input-lg" style="margin-top:13%;font-size:23px;border-radius:5px;" placeholder="Enter OTP Code......." /><br/>

                                <br/><input type="submit" value="Verify" class="btn btn-success btn-lg btn-block custom">
