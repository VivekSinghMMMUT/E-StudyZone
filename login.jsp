                    ...
                    <br/><center>
                        ...
                        <div id="outer2"  class="col-sm-9" style="box-shadow:5px 5px 25px black;margin-left: 12%;border-radius:5px;">
                            ...
                            <form action="generalcode/logincode.jsp" method="post">
                                <br/><br/><input type="text" name="userid" class="form-control input-lg" style="box-shadow: 2px 2px black;margin-top:13%;font-size:23px;border-radius:5px;" placeholder="Username"/><br/>
                                <input type="password" name="password"  class="form-control input-lg"  style="box-shadow: 2px 2px black;font-size:23px;border-radius:5px;" placeholder="Password"/>

                                <br/><input type="submit" value="Log In" class="btn btn-success btn-lg btn-block custom" style="box-shadow: 2px 2px black;">

                            </form>
                           <br/> <a href="forgetpass.jsp">  <b style="color: yellow;"><i>Forgot password</i></b> </a>
                            <span style="margin-left:50%;text-align: left"><b><a href="#" style="text-decoration:none;color:black;">Need Help?</a></b></span>
